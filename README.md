...
After cloning the project, run `generate-card.py` specifying your network
credentials and which template you'd like to use:

```
$ generate-card.py -t card-template.svg "My WiFi Network" "my_wifi_p@ssw0rd" -o card.svg
```
